; Mutation control: an eligible target is delegated to twice.
(set-logic ALL)
...
(assert (= actual-target-calls (ite target-should-run 2 0)))
...
(assert (! violation :named double_proceed_detected))
